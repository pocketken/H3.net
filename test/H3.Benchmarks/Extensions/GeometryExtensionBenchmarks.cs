...
namespace H3.Benchmarks.Extensions {
    ...
    public class GeometryExtensionBenchmarks {
        ...
        private static readonly H3Index[] TestIndexChildren = TestHelpers.SfIndex.GetChildrenForResolution(15).ToArray();
        ...
        public Polygon PocketkenGetCellBoundaryHex() => TestHelpers.SfIndex.GetCellBoundary();
