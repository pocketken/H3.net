...
public sealed class GeoCoord {
    ...
    /// and the destination coordinate.</returns>
    public double GetPointDistanceInKm(GeoCoord p2) {
        return PointDistanceInRadians(Longitude, Latitude, p2.Longitude, p2.Latitude) * EARTH_RADIUS_KM;
    }
    ...
    public static bool operator ==(GeoCoord a, GeoCoord b) => Math.Abs(a.Latitude - b.Latitude) < EPSILON_RAD &&
